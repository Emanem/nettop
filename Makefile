...
FLAGS=-g -Wall 
LIBS=-lpcap -lcurses 
OBJS=$(OBJDIR)/cap_mgr.o $(OBJDIR)/packet_stats.o $(OBJDIR)/name_res.o $(OBJDIR)/proc.o $(OBJDIR)/main.o $(OBJDIR)/settings.o $(OBJDIR)/async_log.o 
EXEC=nettop
...
$(OBJDIR)/main.o: src/main.cpp src/utils.h src/cap_mgr.h src/mt_list.h \
 ...
 src/name_res.h src/settings.h src/epoll_stdin.h src/hashtext_fmt.h $(OBJDIR)/__setup_obj_dir
